...
int maximum_profit(vector<int> A){
    ...
    int ind1=0;
    int ind2=1;
    //finding the first and second minimum in array and capturing their indices
    for(int i=1;i<n;i++)
    {
        if(A[i]<mini)
        {
    ...
    // Traversing two loops from  mini1 to Mini2-1 and second from Mini2 to n-1 and finding out the maximum profit in this range.
