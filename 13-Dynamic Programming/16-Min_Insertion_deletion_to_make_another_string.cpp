// Dynamic Programming: Minimum number of deletions and insertions to transform one string into another
...
int main(){
    ...
    int LCS=topDownLCS(A, B, n, m, dp2);
    cout<<"Total Number of Deletions: "<<m-topDownLCS(A, B, n, m, dp2)<<endl;
    cout<<"Total Number of Insertions: "<<m-topDownLCS(A, B, n, m, dp2)<<endl;
    dp2.clear();
    dp.clear();
}
